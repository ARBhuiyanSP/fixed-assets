          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Asset's Assign [To Employee]</h5>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="id">Employee</label><span class="reqfield"> ***required</span>
									<select class="form-control select2" id="employee_id" name="employee_id" required>
										...
										if (isset($projectsData) && !empty($projectsData)) {
											foreach ($projectsData as $data) {
												?>
												<option value="<?php echo $data['employeeid'] ?>"><?php echo $data['employeeid'] ?>-<?php echo $data['name'] ?></option>
												<?php
											}
										}
										?>
