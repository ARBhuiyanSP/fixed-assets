...
$action.='<span><a class="action-icons c-delete" href="'.$refund_url.'" title="Return"><i class="fas fa-user-minus text-danger mborder" style="padding:2px;margin:1px;border:1px solid gray;"> Return To Store</i></a></span>';
