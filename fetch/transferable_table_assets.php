...
{
	$query .= "owner = '".$_POST["is_owner"]."' AND assign_status='Assigned' AND ";
}else{
	$query .= "assign_status='Assigned' AND";
}
...
$action.='<span><a class="action-icons c-delete" href="'.$transfer_url.'" title="Transfer"><i class="fas fa-users text-warning mborder" style="padding:2px;margin:1px;border:1px solid gray;"> Transfer To Another User</i></a></span>';
