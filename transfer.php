          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title">Asset's Transfer [Employee to Employee]</h5>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control select2" name="employee_id" style="width: 100%;" required >
										...
										<?php 
										$sqlemp	= "select * from `inv_employee` WHERE `employeeid`!='$employee_id' ORDER BY employeeid ASC";
										$resultemp = mysqli_query($conn, $sqlemp);
										while($rowemp=mysqli_fetch_array($resultemp))
											{
										?>
										<option value="<?php echo $rowemp['employeeid'] ?>"><?php echo $rowemp['employeeid'] ?>-<?php echo $rowemp['name'] ?></option>
										<?php } ?>
									</select>
								</div>
							</div>
